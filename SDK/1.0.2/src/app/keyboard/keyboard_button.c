...
void longpress_timeout(void *pxTimer)
{
    ...
    if (resolv_list_exist)
    {
        ...
        else if (app_privacy_resolution_state == LE_PRIVACY_RESOLUTION_ENABLED)
        {
        ...
        else if (app_privacy_resolution_state == LE_PRIVACY_RESOLUTION_DISABLED)
        {
