...
__STATIC_INLINE void GDMA_DLPS_Enter(void)
{
    SYSBLKCTRL->u_210.SOC_FUNC_EN |= SYSBLK_GDMA0_EN_Msk;
...
/**
  ...
  * @retval None
  */
DATA_RAM_FUNCTION __STATIC_INLINE void GDMA_DLPS_Exit(void)
{
    SYSBLKCTRL->u_210.SOC_FUNC_EN |= SYSBLK_GDMA0_EN_Msk;
    PERIPH->PERI_CLK_CTRL |= (SYSBLK_ACTCK_GDMA0_EN_Msk | SYSBLK_SLPCK_GDMA0_EN_Msk);
    ...
    GDMA_BASE->CLEAR_TFR = 0xff;
    GDMA_BASE->CLEAR_BLOCK = 0xff;
    GDMA_BASE->CLEAR_DST_TRAN = 0xff;
    GDMA_BASE->CLEAR_SRC_TRAN = 0xff;
    GDMA_BASE->CLEAR_ERR = 0xff;

    /*--------------------mask interrupt-------- -----------------*/
    GDMA_BASE->MASK_TFR = (GDMA_StoreReg[2] | ((GDMA_StoreReg[2] & 0xff) << 8));
    GDMA_BASE->MASK_BLOCK = (GDMA_StoreReg[3] | ((GDMA_StoreReg[3] & 0xff) << 8));
    GDMA_BASE->MASK_SRC_TRAN = (GDMA_StoreReg[4] | ((GDMA_StoreReg[4] & 0xff) << 8));
    GDMA_BASE->MASK_DST_TRAN = (GDMA_StoreReg[5] | ((GDMA_StoreReg[5] & 0xff) << 8));
    GDMA_BASE->MASK_ERR = (GDMA_StoreReg[6] | ((GDMA_StoreReg[6] & 0xff) << 8));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LCD_DLPS_Enter(void)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void I2S0_DLPS_Enter(void)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void I2S1_DLPS_Enter(void)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_DLPS_Enter(void)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ1_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ2_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ3_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ4_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ5_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);
