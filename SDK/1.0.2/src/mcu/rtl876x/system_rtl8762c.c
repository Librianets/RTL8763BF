...
#if (DEBUG_TASK_HANG_ENABLE == 1)
    extern void DebugTaskHang(void);  //defined in debug_platform.c
    DebugTaskHang();
#endif

#if (DEBUG_DLPS_ERROR_IN_APP_ENABLE == 1)
    void dlps_debug_swtimer_init(void);  //defined in debug_platform.c
    dlps_debug_swtimer_init();
#endif
