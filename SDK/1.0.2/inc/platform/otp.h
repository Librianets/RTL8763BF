...
{
    uint8_t rsvd0[344];                        //start addr:0x00200164
    ...
    uint32_t upper_rsvd4: 25;
    uint8_t upper_rsvd5[8];
    ...
    uint8_t flash_setting_rsvd2[3];            //start addr:0x00200350
    uint8_t flash_dma_ch: 4;
    uint8_t flash_setting_rsvd3: 4;
    /*************end flash_setting *******************/

    uint8_t rsvd1[16];                         //start addr:0x00200354, size:0xe, padding size:0x2
    uint8_t rsvd2[20];                         //start addr:0x00200364, size:0x14
    ...
    uint32_t platform_cfg_rsvd4: 10;
    ...
    uint32_t platform_cfg_rsvd7;         //0x002003d0
    ...
    uint8_t  phy_init_cfg_rsvd[36];     //start addr = 0x002004a8, size=0x24
