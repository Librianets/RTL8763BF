...
#if LE_CODED_PHY_S8
            le_set_phy(conn_id, 0, GAP_PHYS_PREFER_CODED_BIT, GAP_PHYS_PREFER_CODED_BIT,
...
T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    case GAP_MSG_LE_PHY_UPDATE_INFO:
        APP_PRINT_INFO4("GAP_MSG_LE_PHY_UPDATE_INFO:conn %d, cause 0x%x, rx_phy %d, tx_phy %d",
                        p_data->p_le_phy_update_info->conn_id, p_data->p_le_phy_update_info->cause,
                        p_data->p_le_phy_update_info->rx_phy, p_data->p_le_phy_update_info->tx_phy);
