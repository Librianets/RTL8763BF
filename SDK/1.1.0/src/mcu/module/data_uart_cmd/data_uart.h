...
#define FRAMING_SOH         (uint8_t)0x01
#define FRAMING_EOT         (uint8_t)0x04

#define FRAMING_PAYLOAD_MAX_LENGTH  (512 - 10)   //< Minuimum nuber of byte in PL
#define FRAMING_PAYLOAD_MIN_LENGTH  1

#define FRAMING_FRAME_MAX_LENGTH    (FRAMING_PAYLOAD_MAX_LENGTH + 5)
#define FRAMING_FRAME_MIN_LENGTH    (FRAMING_PAYLOAD_MIN_LENGTH + 5)

#define FRAMING_INDEX_SOH                   0
#define FRAMING_INDEX_LENGTH_HIGH           1
#define FRAMING_INDEX_LENGTH_LOW            2
#define FRAMING_INDEX_PAYLOAD               3
