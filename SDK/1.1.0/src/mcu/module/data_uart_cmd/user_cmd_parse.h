...
#define USER_CMD_MAX_COMMAND_LINE       100//70  /**< max. length of command line in bytes */
#define USER_CMD_MAX_HISTORY_LINE       3   /**< max. num of history command line */
#define USER_CMD_MAX_PARAMETERS         18//8   /**< max. number of parameters that the parser will scan */
