...
void app_main_task(void *p_param)
{
    ...
    user_cmd_init(&user_cmd_if, "central-vsop");
	APP_PRINT_INFO0("app_main_task by vsop enter");
    ...
    while (true)
    {
        ...
        if (os_msg_recv(evt_queue_handle, &event, 0xFFFFFFFF) == true)
        {
            ...
            else
            {
				...
				#else
				data_uart_print("#showdev#!0![6100a1100a0e]<Y>\r\n#showdev#!1![6100a1100b03]<Y>\r\n#showdev#!2![6100a1100ab9]<Y>\r\n#showdev#!3![6100a1100ad8]<Y>\r\n");
				os_delay(100);
				#endif
    }
}
