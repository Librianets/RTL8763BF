 ...
 *                              Constants
 *============================================================================*/
/** @brief Default scan interval (units of 0.625ms, 0x10=10ms) */
#define DEFAULT_SCAN_INTERVAL    0x10//0x0c78// 0x10
/** @brief Default scan window (units of 0.625ms, 0x10=10ms) */
#define DEFAULT_SCAN_WINDOW      0x10//0x0c78// 0x10
