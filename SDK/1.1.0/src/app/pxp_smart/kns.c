    ...
    case KNS_PARAM_VALUE_INDEX:
        {
            ...
            *pp_value = (uint8_t *)&gParaValue;
            *p_length = sizeof(gParaValue);
        }
        break;
    }
                                      ...
                                      uint8_t *p_value, P_FUN_WRITE_IND_POST_PROC *p_write_ind_post_proc)
{
    ...
    case KNS_PARAM_VALUE_INDEX:
        ...
        else
        {
            ...
            callback_data.msg_data.write_value = *(uint32_t *)p_value;
        }
        break;
...
{
    kns_attr_read_cb,  // Read callback function pointer
