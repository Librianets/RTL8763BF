 ...
 *                         Macros
 *============================================================================*/
/** @brief PLXS_SERVICE_UUID service related UUIDs. */
...
/** @brief PLXS_APP_ERROR_CODE profile specific attribute protocol application error codes. */
#define PLXS_ERR_PROC_ALREADY_IN_PROGRESS                                         0xFE
#define PLXS_ERR_CCCD_IMPROPERLY_CONFIGURED                                       0xFD

/** @brief PLXS_SPOT_CHECK_FLAGS PLX Spot-check Measurement Characteristic Flags,The Flags field is an 8-bit bit field which indicates what fields are present in the PLX Spot-check Measurement Characteristic value. */
...
/** @brief PLXS_CONTINUOUS_MEAS_FLAGS PLX Continuous Measurement Characteristic Flags,The Flags field is an 8-bit bit field which indicates what fields are present in the PLX Continuous Measurement Characteristic value. */
...
/** @brief PLXS_FEASURES_FLAGS PLX Supported Features field. The Supported Features field is a 16-bit bit field which indicates feature support as well as what fields are present in the PLX Features characteristic. */
...
{
    T_APP_RESULT cause = APP_RESULT_SUCCESS;
    PROFILE_PRINT_INFO3("plxs_attr_write_cb attrib_index = %d, length = %x p_value[1]= %x",
                        attrib_index, length, p_value[1]);
    switch (attrib_index)
    {
#if PLXS_STORE_SPOT_CHECK_MEASUREMENT_SUPPORT
