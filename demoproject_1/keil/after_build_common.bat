...
echo fromelf2
..\tool\prepend_header\prepend_header.exe -t app_code -p "bin\%fromelf_bin%.bin" -m 1 -c sha256 -a "..\..\..\tool\key.json"
echo prepend_header
..\tool\MD5\md5.exe "bin\%fromelf_bin%.bin"
echo md51
..\tool\MD5\md5.exe "bin\%fromelf_bin%_MP.bin"
echo md52
del "bin\%fromelf_bin%_MP.bin"
echo del
