...
/** @defgroup SIMP_UUIDs SIMP UUIDs
  ...
  */
#if 1  //1=cmt4501
#define GATT_UUID_SIMPLE_PROFILE                    0xFFE0//0xA00A  //service
#define GATT_UUID_CHAR_SIMPLE_V1_READ               0xFFE5// 0xB001
#define GATT_UUID_CHAR_SIMPLE_V2_WRITE              0xFFE9 // 0xB002
#define GATT_UUID_CHAR_SIMPLE_V3_NOTIFY             0xFFE4//0xB003  //notify 
#define GATT_UUID_CHAR_SIMPLE_V4_INDICATE           0xFFE7//0xB004 
#else
...
typedef enum
{
    HDL_SIMBLE_SRV_START,           //!<0---- start handle of simple ble service
    HDL_SIMBLE_SRV_END,             //!<1 end handle of simple ble service
    HDL_SIMBLE_V1_READ,             //!<2 V1 read characteristic value handle
    HDL_SIMBLE_V2_WRITE,            //!<3 V2 write characteristic value handle
    HDL_SIMBLE_V3_NOTIFY,           //!<4---- V3 notify characteristic value handle
    HDL_SIMBLE_V3_NOTIFY_CCCD,      //!<5 V3 notify characteristic CCCD handle
    HDL_SIMBLE_V4_INDICATE,         //!<6---- V4 indicate characteristic value handle
    HDL_SIMBLE_V4_INDICATE_CCCD,    //!<7---- V4 indicate characteristic CCCD handle
